  ...
  return (
    <div className='flex items-center justify-center min-h-[60vh] mt-3 lg:flex-row md:flex-col-reverse flex-col-reverse'>
      <div className='p-1'>
        ...
        <button className="text-lg font-medium border-2 border-solid border-[#051d2a] rounded-lg px-3 hover:bg-[#051d2a] hover:text-white transition">Join Now</button>
        <button className="ml-3 text-lg font-medium border-2 border-solid border-[#051d2a] rounded-lg px-3 hover:bg-[#051d2a] hover:text-white transition">Contact Us</button>
      </div>
      <div>
